...
//add short description
    Cuisine(String image, String description, double rating, String longname, String recipe, String price, String ingredients, String shopName, String location, int category, String opentime, String closetime){
        this.image = image;
